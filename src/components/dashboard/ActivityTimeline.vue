    ...
    <div class="space-y-6">
      ...
      >
        ...
        <div
          ...
          class="absolute left-5 top-12 bottom-0 w-px bg-dark-border"
        ></div>
        ...
        <div class="flex-1 pt-1">
          <p class="text-white font-medium mb-1">{{ activity.title }}</p>
...
<script setup>
import { UserPlus, ShoppingCart, FileText, Settings, Clock } from 'lucide-vue-next'
...
const activities = [
  ...
  },
  {
    ...
    description: 'Order #1234 has been placed by Sarah Wilson',
    time: '1 hour ago',
    icon: ShoppingCart,
  ...
  },
  {
    ...
    time: '2 hours ago',
    icon: FileText,
    color: 'bg-gradient-to-br from-accent-pink to-accent-pink-light'
  },
  {
