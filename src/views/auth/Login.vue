        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 cursor-pointer group">
              ...
              <div class="w-5 h-5 border-2 border-surface-3 rounded peer-checked:bg-primary peer-checked:border-primary transition-smooth flex items-center justify-center">
                <Check v-if="form.remember" class="w-3 h-3 text-white" />
              </div>
              <span class="text-sm text-text-secondary group-hover:text-text-primary transition-smooth">Remember me</span>
            </label>
        ...
        <div class="mt-8">
          <div class="relative">
            <div class="absolute inset-0 flex items-center">
              <div class="w-full border-t border-surface-3"></div>
            </div>
            <div class="relative flex justify-center text-sm">
              <span class="px-4 bg-surface-1 text-text-muted">Or continue with</span>
            </div>
          </div>

          <div class="mt-6 grid grid-cols-2 gap-3">
            <button class="flex justify-center items-center px-4 py-3 bg-surface-2 border border-surface-3 rounded-lg hover:bg-surface-3 transition-smooth group">
              <svg class="w-5 h-5 text-text-muted group-hover:text-text-primary mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span class="text-sm text-text-secondary group-hover:text-text-primary">GitHub</span>
            </button>
            <button class="flex justify-center items-center px-4 py-3 bg-surface-2 border border-surface-3 rounded-lg hover:bg-surface-3 transition-smooth group">
              <svg class="w-5 h-5 text-text-muted group-hover:text-text-primary mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span class="text-sm text-text-secondary group-hover:text-text-primary">Google</span>
            </button>
          </div>
        </div>
